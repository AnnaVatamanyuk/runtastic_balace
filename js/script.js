    ...
    $.widget("thomaskahn.smoothDivScroll", {
        options: {
            ...
            switch (method) {
                ...
                case"number":
                    if (!(isNaN(element))) {
                        console.log('el', element, el.data("scrollableArea").children(o.countOnlyClass).eq(element - 1).position());
            ...
            if (el.data("enabled")) {
                if (self._setElementScrollPosition(scrollTo, element)) {
                    ...
                    el.data("scrollWrapper").stop(true, false);
                    console.log('el.data("scrollXPos")', el.data("scrollXPos"));
...
window.onload = function() {
    ...
    $(document).ready(function () {
        ...
        $("#hour-picker").picker({
            data: hourTraining,
            lineHeight: 30,
            selected: timeTraining.hourTraining
        }, function (k) {
            if (hourTraining[k] <= 9){
        ...
        $("#minute-picker").picker({
            data: minuteTraining,
            lineHeight: 30,
            selected: timeTraining.minuteTraining
        }, function (k) {
        ...
        $("#second-picker").picker({
            data: secondTraining,
            lineHeight: 30,
            selected: timeTraining.secondTraining
        }, function (k) {
    ...
    if (inpPersonDistance) {
        inpPersonDistance.addEventListener('click', () => {
    ...
    if (inpPersonCalories) {
        inpPersonCalories.addEventListener('click', () => {
